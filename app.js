 ...
 * Configuration is loaded from config.js (window.ERICA_CONFIG).
 * ============================================================ */

const CONFIG = window.ERICA_CONFIG || {};
if (!CONFIG.SPEECH_KEY || !CONFIG.DIRECT_LINE_SECRET) {
    console.error("Missing config. Edit config.js and set SPEECH_KEY and DIRECT_LINE_SECRET.");
}
